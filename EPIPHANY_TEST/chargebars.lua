...
CoopHUDplus:AddCallback(ModCallbacks.MC_POST_PLAYER_RENDER, EpiphanySamsonCharge, 0)
...
CoopHUDplus:AddCallback(ModCallbacks.MC_POST_PLAYER_RENDER, EpiphanyCainCharge, 0)
